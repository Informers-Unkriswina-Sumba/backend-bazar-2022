  ...
  const pelapakData = [
    {
      ...
      deskripsi:
        'Lapak NUKE adalah lapak kelompok 10 yg bertujuan untuk menjalankan beberapa usaha dalam Basar technopreneurship. Lapak NUKE di artikan dalam nama usaha yg akan di jalankan yaitu Naget pisang, Ubi goreng, Kolak, Es kacang ijo. Keunggulan dari lapak NUKE adalah dapat memberikan kepuasan kepada pelanggan dengan usaha yg kami jalankan, disisi lain lapak NUKE terkenal dengan Naget pisangnya yg gurih dan enak dan dijamin memuaskan pelanggan.',
    ...
    },
    {
      ...
      deskripsi:
        'Sumber rejeki itu banyak arti : Konsumen adalah sumber Rejeki bagi kami dan kami adalah sumber pengetahuan bagi konsumen.',
      logo: 'https://images.unsplash.com/photo-1654779973435-0fae35b3d0fa?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80',
      isSuspended: false,
      createdAt: new Date(),
    },
    {
      ...
      deskripsi:
        'Lapak Tiga Sekawan, keunggulan menjual makanan sehat bergizi dan baik untuk kesehatan tubuh, serta memiliki harga yang terjangkau...',
      logo: 'https://images.unsplash.com/photo-1654779973435-0fae35b3d0fa?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80',
      isSuspended: false,
      createdAt: new Date(),
    },
